...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    uploadPhoto: "Upload a photo for your account",
    editDisplayName: "Edit Display Name",
    changeNameDesc: "Change how your name appears",
    general: "General",
    notifications: "Notifications",
    manageAlerts: "Manage your alerts",
    parkingHistory: "Parking History",
    viewPast: "View past parking sessions",
    vehicleProfile: "Vehicle Profile",
    manageVehicle: "Manage your vehicle info",
    favoriteSpots: "Favorite Spots",
    savedSpots: "Your saved parking spots",
    campusValet: "Campus Valet",
    requestValet: "Request a valet service",
    valetLeaderboard: "Valet Leaderboard",
    topValetUsers: "Top valet users on campus",
    feedback: "Parking Feedback",
    feedbackDesc: "Tell us how easy or hard it was to park",
    valetHistory: "Valet History",
    noValet: "No valet requests yet.",
  ...
  es: {
    ...
    profile: "Perfil",
    addProfilePicture: "Agregar Foto de Perfil",
    uploadPhoto: "Sube una foto para tu cuenta",
    editDisplayName: "Editar Nombre",
    changeNameDesc: "Cambia cómo aparece tu nombre",
    general: "General",
    notifications: "Notificaciones",
    manageAlerts: "Administra tus alertas",
    parkingHistory: "Historial de Estacionamiento",
    viewPast: "Ver sesiones pasadas",
    vehicleProfile: "Perfil del Vehículo",
    manageVehicle: "Administra tu vehículo",
    favoriteSpots: "Lugares Favoritos",
    savedSpots: "Tus lugares guardados",
    campusValet: "Valet del Campus",
    requestValet: "Solicitar servicio de valet",
    valetLeaderboard: "Tabla de Líderes",
    topValetUsers: "Mejores usuarios de valet",
    feedback: "Comentarios de Estacionamiento",
    feedbackDesc: "Dinos qué tan fácil o difícil fue estacionar",
    valetHistory: "Historial de Valet",
    noValet: "Aún no hay solicitudes de valet.",
      ...
      <div className="max-w-2xl mx-auto px-6 py-12 space-y-6">
        ...
        <div className="bg-[#142a1e] border border-[#2a5438] rounded-2xl overflow-hidden">
          ...
          {navLinks.map((item, i) => (
            <Link
              key={item.href}
              href={item.href}
              className={`flex items-center justify-between px-4 py-3 hover:bg-[#1a3d28] transition-colors ${
                i < navLinks.length - 1 ? "border-b border-[#2a5438]/50" : ""
              }`}
            >
              <div className="flex items-center gap-3">
        ...
        <div className="bg-[#142a1e] border border-[#2a5438] rounded-2xl overflow-hidden">
          ...
          {loadingHistory ? (
            ...
            <div className="px-4 py-6 text-center text-xs text-emerald-200/50">
              {t.noValet}
            </div>
          ) : (
            valetHistory.map((item, i) => (
              <div
                key={item.id}
                className={`px-4 py-3 ${
                  i < valetHistory.length - 1 ? "border-b border-[#2a5438]/50" : ""
                }`}
              >
          ...
          <div className="px-4 py-3 border-b border-[#2a5438]/50">
            ...
            <div className="flex gap-2">
              {(["small", "medium", "large"] as const).map((size) => (
                <button
                  key={size}
                  onClick={() => setPendingFontSize(size)}
